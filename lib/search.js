...
class Search {
	...
	anime(term = null, filter = null, page = 1, amount = 5) {
		...
		query += "id title { romaji english native userPreferred } coverImage { large:extraLarge medium:large small:medium color} startDate { year month day } endDate { year month day } } } }";
